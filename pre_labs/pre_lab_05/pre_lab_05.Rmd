...
**Answer**
Most of the cities now only have the first letter uppercase. It also ignored cities that had already been inputed correctly.
```{r}
...
**Answer**
Abell became properly cased, Aberdeen had its first letter upper-cased and so did Accokeek
```{r}
cleaned_md_loans %>%
...
**Answer**
The changes do not substantially vary from key_collision_merge, IE misspellings.
```{r}
cleaned_md_loans <- md_loans %>%

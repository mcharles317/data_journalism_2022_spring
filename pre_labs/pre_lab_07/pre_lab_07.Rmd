...
**Answer**It shows a chart with the different NAICS codes
...
**Answer**
You see the code used to create the graphs being displayed.
...
**Answer**
A breakdown of aspects of different parts of the HTML code
```{r}
# read in the html
...
**Answer**It basically displayed the head of the HTML, showing limited information.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**It highlights how each aspect of the chart was made through HTML code
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**It shows a breakdown of the lists and the rows/columns within this list
...
**Answer**
The list now looks like the graph as seen on the website
...
**Answer**
It provides an output showing the varying sectors and a number value as well.
...
**Answer**
It now gives the descriptions instead of only the NAICS value
```{r}
# Read in all html from table, store all tables on page as nested list of dataframes.
naics_industry <- naics_url %>%
  read_html() %>%
...
**Answer**
It gives a clean version of the NAICS chart, with proper titles
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**This website has a bunch of different charts, all displaying different employment stats
...
**Answer**
Prints list of NAICS descriptions
```{r}
...
**Answer**
Shows a description of the differnt naics codes
```{r}
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
Shows chart labeled 1-20 with 20 different naics codes
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
Labeled 1-10 with 1 value in each row
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
20 sector codes and the coresponding description
```{r}
# Define url of page we want to scrape
...
**Answer**
Gives the naics code, the industry in addition to sector URL and sector paths
...
**Answer**
Gives sector URL and sector path ID
```{r}
...
**Answer**Loop all the rows in the data frame
...
**Answer**
Shows a jumbled block, with each line beggining with row number
```{r}
...
**Answer**
Showed data such as hires, employment, job openings, etc. over a several month stretch
```{r}
...
**Answer**
Shows a change in employment over several months of data.
```{r}
...
**Answer**
Shows an ajudstment in employment fromN ovember to December
```{r}
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
Singles out NAICS code 81 and its November employees
...
**Answer**
Breaks down the industries, describe them and states the number of employees in November
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Charts about mining, quarrying and gas extraction.
### Task 37: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
A webpage of charts, touching on utilities sectors
...
**Answer**
It displays a chart with 19 rows, displaying sectors and descriptions
```{r}

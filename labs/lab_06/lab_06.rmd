...
```{r}
international_migration <- read_csv("tabula-md-statistical-handbook.csv", skip=2, col_names=c("State_Jurisdiction", "July_2011", "July_2012","July_2013", "July_2014", "July_2015", "July_2016", "July_2017", "July_2018", "July_2019", "Total" ))
```
...
**A2** This data shows the percentage of international immigrants that each region or county contributes to the Maryland total. 
...
**A4** In 2018, Republicans won elections across the board which could have led to a shift in policy, thus decreasing the immigration numbers.
...
```{r}
domestic_migration <- read_csv("domestic.csv", skip=2, col_names=c("State_Jurisdiction", "July_2011", "July_2012","July_2013", "July_2014", "July_2015", "July_2016", "July_2017", "July_2018", "July_2019", "Total" ))
```
...
**A7** Any row that shows up in this filter had a net positive migration in all of 2017, 2018 and 2019. Frederick stood out because it had a continuous increase over each of those three years. 

...
description <- paste("The most recent vehicle accidents on WVU's campus", format(wvu_incidentt$title, format="%B %d"), " ", direction, " by ", changetext, "total incidents of this crime", sep="")
sub)
```

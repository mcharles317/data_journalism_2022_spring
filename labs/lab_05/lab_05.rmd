...
-126 E Burke St.
- 6 total loans
- Drew Holding LLC, BRIX27, LLC, ABRAHAM ASHTON, HUB CO-OP LLC, 	
RONIN PROPERTIES LLC

```{r}
clean_address <- read_csv("data/zip-25401-loan-sample-csv.csv")
...
**A2.**
By searching through the varying businesses, the businesses at this address appear suspicious. Despite being located in an office complex, which could explain the same address, it appears that Abraham Ashton is the director for multiple businesses. Additionally, Robert Johnson appears to be the agent for most of the businesses, which could be a coincidence but it appears suspicious. 
...
```{r}
write_csv(Berkley, "data/berkley.csv")
clean_berkeley<- read_csv("data/berkley-csv.csv")
...
berkeley_naics <-clean_berkeley %>% left_join(naics, by ="naics_code")
  martinsburg <-berkeley_naics %>% 
...
**A4.**
-Restaurants are clustered together in the downtown region and according to Google, have received strong reviews thus leading to better business. 
- Martinsburg is a small towm, therefore it likely lacks larger industries. Esepcially in smaller communities, local restraunts and businesses tend to thrive. 
...
- 2021-02-17	
- 94 Jobs Retained
- Kitzie's Resteraunt and Lounge
- 2 Locations, Spring Mills and Martinsburg
- Yes, Kitzie's in Inwood closed during the pandemic
